...
near view $SUB_ACCOUNT nft_tokens_for_owner '{"account_id": "'alice.$SUB_ACCOUNT'"}'

near call $SUB_ACCOUNT nft_transfer '{"token_id": "0", "receiver_id": "alice.'$SUB_ACCOUNT'", "memo": "transfer ownership"}' --accountId $SUB_ACCOUNT --depositYocto 1
